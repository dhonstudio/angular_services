...
export class UserService {
  ...
  async checkUser(db: string, table: string, auth: {username: string, password: string}, user: string | number, user_field_name: string): Promise<User[]> {
  ...
  async checkPassword(db: string, table: string, auth: {username: string, password: string}, user: string | number, user_field_name: string, password: string, password_field_name: string): Promise<User[]> {
